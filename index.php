    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li>
            	<span>Image 01</span>
            		<div>
            			<h3>Kenedy Therapy</h3>
            		</div>
            </li>
            <li><span>Image 02</span><div><h3>Barbara Kenedy</h3></div></li>
            <li><span>Image 03</span><div><h3>Barbara Kenedy</h3></div></li>
            <li><span>Image 04</span><div><h3>Barbara Kenedy</h3></div></li>
            <li><span>Image 05</span><div><h3>Barbara Kenedy</h3></div></li>
            <li><span>Image 06</span><div><h3>Barbara Kenedy</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>Barbara Kenedy & Associates</span></h1>
